...
6. **Capability honesty:** the Oracle system/prompt block and result details state exactly which evidence operations are available and that host actions are not automatic.
